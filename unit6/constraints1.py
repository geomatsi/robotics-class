...
def doit(initial_pos, move1, move2):
    ...
    m_ip = matrix([[1, 0, 0], [0, 0, 0], [0, 0, 0]])
    v_ip = matrix([[initial_pos], [0], [0]])

    m_m1 = matrix([[1, -1, 0], [-1, 1, 0], [0, 0, 0]])
    v_m1 = matrix([[-move1], [move1], [0]])

    m_m2 = matrix([[0, 0, 0], [0, 1, -1], [0, -1, 1]])
    v_m2 = matrix([[0], [-move2], [move2]])

    omega = m_ip + m_m1 + m_m2
    omega.show()
